...
— 2–3 эмодзи максимум
— Никаких хэштегов
— В конце ВСЕГДА добавляй одну реальную рабочую ссылку по теме — статья, инструмент, отчёт о зарплатах, страница компании. Формат: 🔗 [название](url). Используй только реально существующие URL.`,
      messages: [
        {
          role: "user",
